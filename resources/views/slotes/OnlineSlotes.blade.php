...
@section('head1') Online Slotes @endsection
                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @endif
                                                <td>
                                                    <span class="badge light badge-primary" style="cursor:pointer;" onclick="window.open('/administrator/slote-curdates/{{encrypt($s->id)}}/{{$s->day}}', '_blank')">{{date('M')}}</span>
                                                  
                                                   <span class="badge light badge-primary" style="cursor:pointer;" onclick="window.open('/administrator/slote-alldates/{{encrypt($s->id)}}', '_blank')">History</span>
                                                   
                                                </td>
                                                <td>
                                                   <span class="badge light badge-primary" style="cursor:pointer;" onclick="window.open('/administrator/student-slotes/{{encrypt($s->id)}}', '_blank')"><i class="fa fa-users"></i></span>
...
type:"POST",
url:"/administrator/onlineslote-edit",
data:data,
dataType:"json",
contentType: false,
//cache: false,
...
type:"POST",
url:"/administrator/onlineslote-add",
data:data,
dataType:"json",
contentType: false,
//cache: false,
...
$.ajax({
              ...
              type:"POST",
              url:'/administrator/delete-slote',
              data: {
