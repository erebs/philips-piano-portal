                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                ...
                                @php
                                $msgcnt=DB::table('chats')->where('visibility','Pending')->where('sender','!=','Admin')->groupBy('sender')->orderBy('created_at','DESC')->get();
                                @endphp
                                    <span class="badge light text-white bg-warning rounded-circle">{{count($msgcnt)}}</span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    <div id="DZ_W_Notification1" class="widget-media dlab-scroll p-3" style="height:380px;">
                                        <ul class="timeline">
                                            @foreach($msgcnt as $ms)
                                            @php
                                 $stdname=DB::table('students')->select('name')->where('id',$ms->sender)->first();
                                            @endphp
                                            <li style="cursor:pointer;" onclick="window.location.href='/administrator/chats/{{encrypt($ms->sender)}}'">
                                                <div class="timeline-panel">
                                                    <!-- <div class="media me-2">
                                                        <img alt="image" width="50" src="images/avatar/1.jpg">
                                                    </div> -->
                                                    <div class="media-body">
                                                        <h6 class="mb-1">{{$stdname->name}}</h6>
                                                        <small class="d-block">{{date("d-m-Y H:i A", strtotime($ms->created_at))}}</small>
                                                    </div>
                                                </div>
                                            </li>
                                            @endforeach
                ...
                <ul class="metismenu" id="menu">
                 ...
                 <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/online-slotes">Online</a></li>
                            <li><a href="/administrator/offline-branches">Offline</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/add-plan">Add new</a></li>
                            <li><a href="/administrator/plans">Plans</a></li>
                            <li><a href="/administrator/deposit">Other Fees</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/active-students">Active</a></li>
                            <li><a href="/administrator/expired-students">Expired</a></li>
                            <li><a href="/administrator/blocked-students">Blocked</a></li>
                            <li><a href="/administrator/deactivated-students">Deactivated</a></li>
                            <li><a href="/administrator/completed-students">Course Completed</a></li>
                        </ul>
                    </li>

                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-inbox"></i>
                            <span class="nav-text">Extra Class</span>
                        </a>
                        <ul aria-expanded="false">
                           
                            <li><a href="/administrator/credit-classes">Pending Credit Classes</a></li>
                            <li><a href="/administrator/paid-classes">Pending Paid Classes</a></li>
                             <li><a href="/administrator/cancelled-classes">Rebook Pending Classes</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/pending-refund-requests">Pending</a></li>
                            <li><a href="/administrator/paid-refund-requests">Paid</a></li>
                            <li><a href="/administrator/rejected-refund-requests">Rejected</a></li>
                        </ul>
                    </li>
                     ...
                     <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/add-teacher">Add New</a></li>
                            <li><a href="/administrator/active-teachers">Active</a></li>
                            <li><a href="/administrator/blocked-teachers">Blocked</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/deposit-report">Deposits</a></li>
                            <li><a href="/administrator/single-fee">Single Fee Payment</a></li>
                            <li><a href="/administrator/installment-fee">Fee Installments</a></li>
                            <li><a href="/administrator/paid-class-report">Paid Classes</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/add-blog">Add Blog</a></li>
                            <li><a href="/administrator/blogs">Blogs</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/add-video">Add Video</a></li>
                            <li><a href="/administrator/videos">Videos</a></li>
                        </ul>
                    </li>
