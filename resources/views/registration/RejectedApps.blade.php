...
@section('title')
 Applications
  @endsection
  @section('head1')  Rejected Applications @endsection 
@section('contents')
                                    ...
                                    <table id="example" class="display" style="min-width: 945px;font-size:5px !important;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$s->mobile}},{{$s->alternative_mobile}}</td>
                                                
                                              
                                                <td>{{date("d-M-Y", strtotime($s->rejected_at))}}</td>
                                                ...
                                                <td>
													...
													<div class="dropdown ms-auto text-end">
														...
														<div class="dropdown-menu dropdown-menu-end">
															<a class="dropdown-item" style="cursor: pointer;" onclick="window.location.href='/administrator/student-view/{{encrypt($s->id)}}'">view</a>
