...
@section('title')
 Report
  @endsection
  @section('head1') Deposits @endsection 
@section('contents')
        ...
        <div class="content-body">
            <div class="container-fluid">
                 ...
                 <div class="row page-titles">
                    <form action="/administrator/get-deposits" method="POST" target="_blank"> 
                    @csrf 
                        <div class="row">
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$s->name}}</td>
                                                <td>{{$s->mobile}}</td>
                                                <td>{{date("d-M-Y", strtotime($s->deposit_date))}}</td>
                                                <td>Rs.{{$s->deposit_amount}}</td>
                                                <td>{{$s->deposit_repay_status}}</td>
