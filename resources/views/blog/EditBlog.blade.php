...
@section('head1') Edit Blog @endsection
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-6">
														<input type="text" class="form-control" placeholder="Enter name" id="name" value="{{$blog->title}}">
                                             ...
                                             <div class="col-xl-12">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <textarea class="form-control ckeditor" id="desc" rows="10" cols="10">{{$blog->details}}</textarea>
                                                    </div>
                                                </div>
