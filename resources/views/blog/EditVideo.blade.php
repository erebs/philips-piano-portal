                                        ...
                                        <div class="row">
                                            <div class="col-xl-6">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" placeholder="Enter title" id="name" value="{{$video->title}}">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <input type="text" class="form-control" placeholder="Enter video url" id="url" value="{{$video->link}}">
                                             ...
                                             <div class="col-xl-12">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <textarea class="form-control ckeditor" id="desc" rows="10" cols="10">{{$video->details}}</textarea>
                                                    </div>
                                                </div>
  ...
  if(data['success'])
  {
    ...
    $('#ab1').show();
            Toastify({
              ...
              callback: function () {
               // alert("sss");
              window.location.href='/administrator/videos';
              },
            }).showToast();
