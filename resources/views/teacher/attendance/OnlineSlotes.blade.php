                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @endif
                                                <td>
                                                   <span class="badge light badge-primary" style="cursor:pointer;" onclick="window.open('/teacher/slote-curdates/{{encrypt($s->id)}}/{{$s->day}}', '_blank')">{{date('M')}}</span>
                                                  
                                                   <span class="badge light badge-primary" style="cursor:pointer;" onclick="window.open('/teacher/slote-alldates/{{encrypt($s->id)}}', '_blank')">History</span>
